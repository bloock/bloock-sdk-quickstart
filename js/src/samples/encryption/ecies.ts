import { BloockClient, RecordBuilder, EciesDecrypter, EciesEncrypter } from "@bloock/sdk";
import { Config } from "../../utils/config";
import { Sample } from "../../utils/sample";
import { Logger } from "../../utils/logger";

Sample.run("ECIES encryption", async (_: Config) => {
  ...
  try {
    await RecordBuilder.fromRecord(encryptedRecord)
      .withDecrypter(new EciesDecrypter("an invalid key"))
      .build();
  } catch {
