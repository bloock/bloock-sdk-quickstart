...
from bloock.client.entity.decrypter import RsaDecrypter
from bloock.client.entity.encrypter import RsaEncrypter
...
def rsa(_: Config):
    ...
    keypair = sdk.generate_rsa_keypair()
    ...
    encrypted_record = (
        ...
        .with_encrypter(RsaEncrypter(keypair.public_key))
        .build()
    )
    ...
    decrypted_record = (
        ...
        .with_decrypter(RsaDecrypter(keypair.private_key))
        .build()
    )
