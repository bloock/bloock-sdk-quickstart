...
def encryption(_: Config):
    ...
    encrypted_record = RecordBuilder\
            .from_string(payload)\
    ...
    decrypted_record = RecordBuilder\
    ...
    try:
        RecordBuilder\
            .from_record(encrypted_record)\
            .with_decrypter(AesDecrypter("an invalid password"))\
            .build()
    except:
